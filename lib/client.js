...
function BoltIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: "0 0 24 24", width: "15", height: "15", "aria-hidden": "true", style: { display: "block" }, children: [
...
function SkillPickerButton(props) {
  ...
  const onKeyDown = (event) => {
    if (event.key === "ArrowDown") {
      ...
      if (skill !== void 0) pick(skill.name);
